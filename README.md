...
```sh
    {
        devAddr: <Buffer 78 c5 e5 9b 5e f8>,                           // Device public address
...
--------------------------
These tables are cross-references between the **Vendor-Specific HCI Command** and **ccBnp Command API** names.
